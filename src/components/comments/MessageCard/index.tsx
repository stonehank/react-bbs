...
function MessageCard(props) {
  const { index, details, small, curNest, maxNest, loadList, updateCommentAsync } = props
  return (
    <div id={details.objectId}>
...
function propsAreEqual(prevProps, nextProps) {
  return (
    prevProps.details.objectId === nextProps.details.objectId &&
